...
const OPEN_KIOSK_ON_STARTUP = process.env.CAREID_OPEN_KIOSK_ON_STARTUP !== 'false';
...
if (!gotSingleInstanceLock) {
  log.info('Another CareID Kiosk Bridge instance is already running. Exiting duplicate instance.');
  app.quit();
} else {
...
function rebuildMenu() {
  ...
  const menu = Menu.buildFromTemplate([
    ...
    { type: 'separator' },
    { label: 'Abrir Kiosk CareID', click: () => openKiosk({ force: true }) },
